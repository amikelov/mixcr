    ...
    fun testExport2() {
        for (presetName in Presets.nonAbstractPresetNames) {
            ...
            val tagsInfo = TagsInfo(
                ...
                TagInfo(TagType.Cell, TagValueType.Sequence, "CELL1ROW", 1),
                TagInfo(TagType.Cell, TagValueType.Sequence, "CELL2COLUMN", 2),
                TagInfo(TagType.Cell, TagValueType.Sequence, "CELL3PLATE", 3),
